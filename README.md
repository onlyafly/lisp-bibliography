...
- [Lisp Bibliography](#lisp-bibliography)
	...
	- [Lisp Implementation](#lisp-implementation)
		...
		- [Implementing Macros](#implementing-macros)
	- [Monads](#monads)
	- [Scheme/Lisp](#schemelisp)
	- [Compiler/Interpreter Phases](#compilerinterpreter-phases)
		- [Parsing](#parsing)
		- [Analysis](#analysis)
...
*Note: Table of contents generated by Atom's markdown-toc package.*
